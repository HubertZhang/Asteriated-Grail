...
class Card
{
    int cnumber;             //each card will ba allocated with a specific number.
                             //This number is
    int cstatus;             //status of this card
                             //(There are ten status of card.Wind,water,fire,ground,thunder,dark.weak,poison,sheild,bomb,light)
